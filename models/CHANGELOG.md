...
### Changed
- Fix incorrect input shape in `*-discogs-effnet-1.json` classification heads metadata files released on 2022-08-25: 1200 -> 1280 (https://github.com/MTG/essentia/issues/1490)
