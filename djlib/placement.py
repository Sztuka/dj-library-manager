...
CLUB_GENRE_KEYS = {
    ...
    "HARDSTYLE", "AFRO_HOUSE", "ELECTRO_SWING", "TRANCE", "PSYTRANCE", "DNB",
    "DUBSTEP", "BREAKBEAT", "SOULFUL_HOUSE", "UK_GARAGE", "DEEP_HOUSE",
    "PROGRESSIVE_HOUSE",
}
...
VIBE_MAP = [
    ...
    ({"ROCK", "ALTERNATIVE_ROCK", "INDIE_ROCK", "METAL", "PUNK"}, "OPEN FORMAT/ROCK CLASSICS"),
    ({"FUNK"}, "OPEN FORMAT/FUNK"),
    ({"SOUL", "BLUES"}, "OPEN FORMAT/SOUL"),
    ({"DISCO", "NU_DISCO", "ITALO_DISCO"}, "OPEN FORMAT/DISCO"),
    ({"POP", "DANCE", "SYNTHPOP", "INDIE_POP"}, "OPEN FORMAT/POP"),
    ({"JAZZ"}, "OPEN FORMAT/JAZZ"),
    ({"NEW_WAVE", "SYNTHWAVE"}, "OPEN FORMAT/NEW WAVE"),
    ({"REGGAE", "DANCEHALL"}, "OPEN FORMAT/REGGAE"),
